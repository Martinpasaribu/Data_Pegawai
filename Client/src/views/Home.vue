<template>
  <div class="bg-white">
    <h1 class="text-birut2  text-center text-2xl font-bold font-sans "> Pegawai</h1>

    <div class="grid grid-cols-4 p-4 gap-6 w-full h-[40rem] overflow-auto ">
      <div
        v-for="(item, index) in datas"
        :key="item.id"
        class="hover:scale-110 duration-300 hover:shadow-bayang hover:text-birut text-black"
      >
